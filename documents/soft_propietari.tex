...
\section{Ús actual}
	...
	prèvia instal·lació de software propietari als ordinadors. La falta d'informació del que 
	comporta l'ús de programes propietaris.

	\begin{figure}[ht!]
	\centering
	\includegraphics[width=100mm]{data/web_servers_share.png}
	\caption{Ús de software propietari/lliure \cite{whyfoss}}
	\label{websshare}
	\end{figure}
